...
export const STATISTICS_ACTIVITY_PATH = "dashboard/activities/statistics";
...
export const STATISTICS_GOAL_PATH = "dashboard/goals/statistics";
...
// Achievements Routes & Paths
export const ALL_ACHIEVEMENTS_PATH = "/dashboard/achievements/all";
export const STATISTICS_ACHIEVEMENTS_PATH =
  "/dashboard/achievements/statistics";
